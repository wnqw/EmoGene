...
This guide is about building a python environment for EmoGene with Conda.

The following installation process is verified in A6000 + CUDA11.7.
...
conda create -n emogene python=3.9
conda activate emogene
...
You can download a zipped file in this [Google Drive](https://drive.google.com/drive/folders/1o4t5YIw7w4cMUN4bgU9nPf6IyWVG1bEk?usp=drive_link). Unzip it, you can see a `BFM` folder with 8 files. Move these files into the path `<EmoGeneRoot>/deep_3drecon/BFM/`. The structure should look like:
```
deep_3drecon/BFM/
...
# 4. Download MEAD emotion video dataset
You can download the MEAD dataset [here](https://wywu.github.io/projects/MEAD/MEAD.html).